    ...
    <div className="pt-[120px] pb-20 px-[clamp(1.25rem,5vw,4rem)] max-w-[1000px] mx-auto min-h-screen">
      ...
      <div className="mb-12">
        <h2 className="font-mono text-lg text-fg tracking-[0.1em] mb-6 flex items-center gap-3">
          <span className="text-accent">01.</span> CORE RESPONSIBILITIES
        </h2>
      ...
      <div className="mb-12">
        <h2 className="font-mono text-lg text-fg tracking-[0.1em] mb-6 flex items-center gap-3">
          <span className="text-accent">02.</span> KEY ACHIEVEMENTS
        </h2>
      ...
      <div className="mb-12">
        <h2 className="font-mono text-lg text-fg tracking-[0.1em] mb-6 flex items-center gap-3">
          <span className="text-accent">03.</span> TECHNOLOGIES USED
        </h2>
